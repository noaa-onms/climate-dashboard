...
if (file.exists(clim_csv))
  ...
  <details>
  <summary><span style="color: #737373; font-size: 12px">Metadata</span></summary>
  This climate forecast dataset [CESM2 Large Ensemble Community Project (LENS2) | Community Earth System Model](https://www.cesm.ucar.edu/community-projects/lens2) was provided by UCAR as netCDF4 files summarized to the sanctuary over time and summarized annually and output to CSVs by [process_nc.R](https://github.com/noaa-onms/climate-dashboard/blob/main/scripts/process_nc.R).
  </details> 
  '))
```
