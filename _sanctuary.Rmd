...
if (file.exists(clim_csv))
  cat(glue(
  '### Sea Surface Temperature Annual Climate Projection {{data-height=300}}
  
  <details>
  <summary><span style="color: #737373; font-size: 12px">Metadata</span></summary>
  This climate forecast dataset [CESM2 Large Ensemble Community Project (LENS2) | Community Earth System Model](https://www.cesm.ucar.edu/community-projects/lens2) was provided by UCAR as netCDF4 files summarized to the sanctuary over time monthly since 1850 and out to 2100. These data were summarized annually and output to CSVs by [process_nc.R](https://github.com/noaa-onms/climate-dashboard/blob/main/scripts/process_nc.R).
  </details> 
  '))
```
...
plot_ts(clim_csv, fld_avg = "sst_mean", fld_sd = "sst_sd", fld_date = "year")
```
